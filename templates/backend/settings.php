...
<div id="yith-woocommerce-customer-history">
	<div id="settings" class="wrap">
        ...
        .adv-box { max-width: 300px; background-color: #ddd; border: 1px solid #ccc; padding: 30px 20px; margin-right: 20px; margin-bottom: 20px; float: left; }
        .adv-box h2 { margin-top: 0px; }
        .adv-box .warning { color: #a00; }
