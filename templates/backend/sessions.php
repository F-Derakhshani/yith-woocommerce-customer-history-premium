...
$rows = $wpdb->get_results( "SELECT * FROM {$wpdb->prefix}yith_wcch_sessions WHERE $user_query del='0'" );
$num_rows = $wpdb->num_rows;
$max_pages = ceil( $num_rows / $results_per_page );

$trash_rows = $wpdb->get_results( "SELECT * FROM {$wpdb->prefix}yith_wcch_sessions WHERE $user_query del='1'" );
$trash_num_rows = $wpdb->num_rows;
    ...
    <div id="sessions" class="wrap">
        ...
        <div class="tablenav top">
            ...
            <ul class="subsubsub" style="margin: 1px 0px 0px 10px; display: inline-block; float: none;">
                ...
                <li class="trash"><a href="admin.php?page=yith-wcch-trash.php&user_id=<?php echo $user_id; ?>" style="padding-right: 0;"><?php echo __( 'Trash', 'yith-woocommerce-customer-history' ); ?></a> (<?php echo $trash_num_rows; ?>)</li>
            </ul>
                ...
                foreach ( $rows as $key => $value ) :
                    ...
                    if ( $url ) : ?>
                        ...
                        <tr class="<?php echo ( isset( $user->caps['administrator'] ) && $user->caps['administrator'] ? 'admin' : '' ) . ' ' . $tr_class; ?>">
                            ...
                            <td class="referer"><?php echo isset( $value->referer ) ? $value->referer : ''; ?></td>
